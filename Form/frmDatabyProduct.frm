...
Begin VB.Form frmDatabyProduct 
   Caption         =   "Laporan Data By Product"
   ClientHeight    =   5280
   ClientLeft      =   5280
   ClientTop       =   3495
   ClientWidth     =   11745
   ...
   ControlBox      =   0   'False
   Icon            =   "frmDatabyProduct.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   5280
   ...
   Begin VB.ComboBox cboCustomer 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmDatabyProduct.frx":6852
      Left            =   1845
      List            =   "frmDatabyProduct.frx":6854
      TabIndex        =   1
      Text            =   "cboCustomer"
      Top             =   45
      Width           =   3930
   ...
   Begin lvButton.lvButtons_H cmdSearch 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmDatabyProduct.frx":6856
      cBack           =   -2147483633
   End
   Begin lvButton.lvButtons_H cmdRefresh 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmDatabyProduct.frx":6FD0
      cBack           =   16119285
   End
   Begin lvButton.lvButtons_H cmdClose 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmDatabyProduct.frx":774A
      cBack           =   16119285
   End
   Begin lvButton.lvButtons_H cmdExport 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmDatabyProduct.frx":A9AC
      cBack           =   16119285
   End
   ...
   End
End
Attribute VB_Name = "frmDatabyProduct"
...
With SQLParser
    .Fields = "a.plant_mark,a.mkt_customer_id,e.name AS customer_name, a.eng_product_id,b.internal_part_id,b.name AS product_name, " & _
                "b.cavity,b.prod_yield AS target_yield,b.weight_gr,b.cycle_time_ia, " & _
    ...
    .Tables = "prod_runnings a " & _
        ...
        Else
            .wCondition = "a.period_shift between '" & Format(DTAwal.Value, "yyyy-mm-dd") & "' and '" & Format(DTAkhir.Value, "yyyy-mm-dd") & "' and e.name  = '" & cboCustomer.text & "' and a.plant_mark = '" & p_plant_mark & "'"
        End If

    .GroupOrder = "a.plant_mark,a.mkt_customer_id,a.eng_product_id"
    .SortOrder = "e.name,b.name ASC"
    .SaveStatement
End With
...
On Error Resume Next
    If WindowState <> vbMinimized Then
        ...
        lvList.Height = Me.ScaleHeight - 1100
    End If
...
With lvList
    ...
    Set srcItem = .ListItems.Add(, , i, 1, 1)
        ...
        srcItem.SubItems(4) = RS_PRODBYCUST.Fields("jumlah_shot")
        srcItem.SubItems(5) = RS_PRODBYCUST.Fields("gross_produksi")
        srcItem.SubItems(6) = RS_PRODBYCUST.Fields("jumlah_ng")
        srcItem.SubItems(7) = RS_PRODBYCUST.Fields("net_produksi")
        srcItem.SubItems(8) = RS_PRODBYCUST.Fields("target_yield")
        srcItem.SubItems(9) = RS_PRODBYCUST.Fields("prod_yield")
        srcItem.SubItems(10) = RS_PRODBYCUST.Fields("persen_target")
        srcItem.SubItems(11) = RS_PRODBYCUST.Fields("runn_hours")
