...
Begin VB.Form frmAdjustshotAE 
   ...
   Begin VB.ComboBox cboProduct 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustshotAE.frx":15162
      Left            =   2250
      List            =   "frmAdjustshotAE.frx":15164
      TabIndex        =   19
      Text            =   "cboProduct"
      Top             =   1530
      Width           =   5460
   ...
   Begin VB.ComboBox cboMachine 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustshotAE.frx":15166
      Left            =   2250
      List            =   "frmAdjustshotAE.frx":15168
      TabIndex        =   18
      Text            =   "cboMachine"
      Top             =   1080
      Width           =   1635
   ...
   Begin VB.ComboBox cboJam 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustshotAE.frx":1516A
      Left            =   2250
      List            =   "frmAdjustshotAE.frx":151B6
   ...
   Begin lvButton.lvButtons_H cmdSave 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAdjustshotAE.frx":1521A
      cBack           =   -2147483633
   End
   Begin VB.ComboBox cboAdjust 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustshotAE.frx":2C2B4
      Left            =   2250
      List            =   "frmAdjustshotAE.frx":2C2BE
      Style           =   2  'Dropdown List
      TabIndex        =   12
      Top             =   3825
      Width           =   1635
   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin VB.Image Image1 
         Height          =   720
         Left            =   0
         Picture         =   "frmAdjustshotAE.frx":2C2D2
         Top             =   90
         Width           =   720
      End
   ...
   Begin lvButton.lvButtons_H cmdCancel 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAdjustshotAE.frx":3244C
      cBack           =   -2147483633
   End
   ...
   End
End
Attribute VB_Name = "frmAdjustshotAE"
...
If State = AddStateMode Then
    ...
    sSQL = "SELECT prod_adjust_shots.* FROM prod_adjust_shots limit 1"
...
frmAdjustshot.CommandPass "Refresh"
Set frmAdjustshotAE = Nothing
