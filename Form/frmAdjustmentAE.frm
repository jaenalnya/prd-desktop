...
Begin VB.Form frmAdjustmentAE 
   ...
   Begin VB.ComboBox cboProduct 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustmentAE.frx":15162
      Left            =   2250
      List            =   "frmAdjustmentAE.frx":15164
      TabIndex        =   21
      Text            =   "cboProduct"
      Top             =   1980
      Width           =   5460
   ...
   Begin VB.ComboBox cboCustomer 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustmentAE.frx":15166
      Left            =   2250
      List            =   "frmAdjustmentAE.frx":15170
      TabIndex        =   20
      Text            =   "cboCustomer"
      Top             =   1530
      Width           =   5460
   ...
   Begin VB.ComboBox cboMachine 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustmentAE.frx":15184
      Left            =   2250
      List            =   "frmAdjustmentAE.frx":15186
      TabIndex        =   19
      Text            =   "cboMachine"
      Top             =   1080
      Width           =   1635
   ...
   Begin VB.ComboBox cboJam 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustmentAE.frx":15188
      Left            =   2250
      List            =   "frmAdjustmentAE.frx":151D4
   ...
   Begin lvButton.lvButtons_H cmdSave 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAdjustmentAE.frx":15238
      cBack           =   -2147483633
   End
   Begin VB.ComboBox cboAdjust 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmAdjustmentAE.frx":2C2D2
      Left            =   2250
      List            =   "frmAdjustmentAE.frx":2C2DC
      Style           =   2  'Dropdown List
      TabIndex        =   13
      Top             =   3825
      Width           =   1635
   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin VB.Image Image1 
         Height          =   720
         Left            =   0
         Picture         =   "frmAdjustmentAE.frx":2C2F0
         Top             =   90
         Width           =   720
      End
   ...
   Begin lvButton.lvButtons_H cmdCancel 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAdjustmentAE.frx":3246A
      cBack           =   -2147483633
   End
   ...
   End
End
Attribute VB_Name = "frmAdjustmentAE"
