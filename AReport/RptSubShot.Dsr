VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptSubShot 
   Caption         =   "Laporan Shot"
   ClientHeight    =   12375
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   22800
   ...
   _ExtentX        =   40217
   _ExtentY        =   21828
   SectionData     =   "RptSubShot.dsx":0000
End
Attribute VB_Name = "RptSubShot"
...
On Error Resume Next
    With DTRpt.Recordset
        If Not .EOF Then
            ...
            txtStatus.Text = .Fields("Status").Value
