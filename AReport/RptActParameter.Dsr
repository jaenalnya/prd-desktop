VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptActParameter 
   Caption         =   "Actual Parameter"
   ClientHeight    =   14025
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   28680
   Icon            =   "RptActParameter.dsx":0000
   StartUpPosition =   3  'Windows Default
   WindowState     =   2  'Maximized
   _ExtentX        =   50588
   _ExtentY        =   24739
   SectionData     =   "RptActParameter.dsx":617A
End
Attribute VB_Name = "RptActParameter"
...
qSQL = qSQL & " e.prod_yield,e.material_name,e.color_name FROM eng_paramset_actuals a"
...
qSQL = qSQL & " a.eng_product_id = '" & p_eng_product_1 & "' and a.date = '" & Format(p_shift, "yyyy-mm-dd") & "'"
