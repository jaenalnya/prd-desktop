VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptSupirCustomer 
   Caption         =   "LAPORAN PENGIRIMAN PER SUPIR"
   ClientHeight    =   10950
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   20250
   Icon            =   "RptSupirCustomer.dsx":0000
   StartUpPosition =   2  'CenterScreen
   WindowState     =   2  'Maximized
   _ExtentX        =   35719
   _ExtentY        =   19315
   SectionData     =   "RptSupirCustomer.dsx":169B2
End
Attribute VB_Name = "RptSupirCustomer"
...
With Me
    ...
    .txtTimbang2.DataField = "Gross"
    .txtTimbang1.DataField = "tare"
