...
Call SocketsInitialize
    ...
    Dim temp_ip_Alamat() As Byte
    Dim i As Integer
    Dim ip_Alamat As String
    ...
    Do
        ReDim temp_ip_Alamat(1 To host.hLength)
        RtlMoveMemory temp_ip_Alamat(1), hostip_addr, host.hLength


        For i = 1 To host.hLength
            ip_Alamat = ip_Alamat & temp_ip_Alamat(i) & "."
        Next
        ip_Alamat = Mid$(ip_Alamat, 1, Len(ip_Alamat) - 1)
