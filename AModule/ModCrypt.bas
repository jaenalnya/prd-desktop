...
Option Explicit
Public Function JaeDecrypt(vText As String, Optional key As String) As String
...
Public Function JaeEncrypt(vText As String, Optional key As String) As String
